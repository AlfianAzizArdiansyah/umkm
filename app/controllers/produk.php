...
class Produk extends Controller
{
	...
	{
		$user = $this->model('UserModel')->detailUser($_SESSION['id']);

		if (!$user || empty($user['toko_id'])) {
			Flasher::setMessage('Gagal', 'Toko belum terdaftar', 'danger');
			header('location: ' . base_url . '/produk');
			exit;
		}

		$_POST['toko_id'] = $user['toko_id'];
