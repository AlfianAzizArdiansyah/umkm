			...
			<div class="row">
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_contents">
						...
						<p>Selamat datang di Sistem Informasi UMKM yang inovatif dan dapat diandalkan! Kami hadir untuk
							memberdayakan UMKM dengan teknologi canggih, menyederhanakan operasi bisnis Anda, dan
							membantu Anda mencapai kesuksesan yang lebih besar. Bergabunglah dengan kami hari ini untuk
							merasakan perubahan positif dalam bisnis Anda.</p>
					</div>
				</div>
						...
						<form method="POST" action="<?= base_url; ?>/auth/prosesLogin">
							...
							<div class="submit-button">
								<button id="review_submit" type="submit"
									class="red_button message_submit_btn trans_300">Login</button>
								<p>Belum punya akun? Klik <a href="<?= base_url . '/auth/register' ?>">daftar</a> untuk
									bergabung</p>
							</div>
						</form>
					</div>
