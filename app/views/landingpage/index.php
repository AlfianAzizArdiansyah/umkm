<!-- Home -->
<div class="main_slider" style="background-image:url(<?= base_url; ?>/dist/img/slider1.png)" id="home">
					...
					<ul class="arrivals_grid_sorting clearfix button-group filters-button-group">
						...
						<?php foreach ($data['kategori'] as $key => $kategori): ?>
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center"
								data-filter="<?= '.' . $kategori['nama_kategori'] ?>"><?= $kategori['nama_kategori'] ?></li>
						<?php endforeach; ?>
					</ul>
				</div>
			</div>
					...
					<?php foreach ($data['produk'] as $key => $produk): ?>
						...
						<div class="product-item <?= $produk['nama_kategori'] ?>">
							...
							<div class="red_button add_to_cart_button"><a
									href="<?= base_url . '/landingpage/detail_product/' . $produk['id']; ?>">Cek Detail
									Produk</a></div>
						</div>
					<?php endforeach; ?>
				</div>
		...
		<div class="row">
			<div class="col-lg-6 contact_col">
				<div class="contact_contents">
					<h1>Kontak</h1>
					<p>Ada banyak cara untuk menghubungi kami. Anda dapat mengirimkan pesan, menelepon kami, atau
						mengirim email, pilih yang paling sesuai untuk Anda.</p>
					<div>
						<p>Bu Candra</p>
						<p>08</p>
					</div>
			...
			<div class="col-lg-6 get_in_touch_col" id="kontak">
				<div class="get_in_touch_contents">
					<h1>Hubungi Kami!</h1>
					<p>Isi formulir di bawah ini untuk menerima penawaran gratis dan rahasia.</p>
					<form action="post">
						<div>
