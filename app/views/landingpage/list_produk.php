		...
		<div class="col product_section clearfix">
			...
			<div class="breadcrumbs d-flex flex-row align-items-center">
				<ul>
					...
					<li class="active"><a href="index.html"><i class="fa fa-angle-right" aria-hidden="true"></i>List
							Produk</a></li>
				</ul>
			</div>
				...
				<div class="sidebar_section">
					...
					<ul class="sidebar_categories">
						...
						<?php foreach ($data['kategori'] as $key => $kategori): ?>
							<li><a
									href="<?= base_url . '/landingpage/kategori/' . $kategori['nama_kategori'] ?>"><?= $kategori['nama_kategori']; ?></a>
							</li>
						<?php endforeach; ?>
									...
									<div class="product-item men">
										<div class="product discount product_filter">
											...
											<div class="product_info">
												...
												<div class="product_price">Rp. <?= number_format($produk['harga'], 0); ?>
												</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a
												href="<?= base_url . '/landingpage/detail_product/' . $produk['id']; ?>">Cek
												Detail Produk</a></div>
									</div>
								<?php endforeach; ?>
							</div>
										...
										<div class="page_current">
											...
											<ul class="page_selection">
												<?php for ($i = 0; $i < $data['paginate']; $i++): ?>
													<li><a
															href="<?= base_url; ?>/landingpage/page/<?= $i + 1 ?>"><?= $i + 1; ?></a>
													</li>
												<?php endfor; ?>
											</ul>
										</div>
