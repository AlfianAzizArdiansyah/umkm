            ...
            <?php foreach ($data['produk'] as $row): ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?= base_url; ?>/produk/hapus/<?= $row['id'] ?>" class="btn btn-xs btn-danger"
            ...
            <ul class="pagination">
              <li
                ...
                id="example1_previous"><a
                  href="<?= base_url; ?>/produk/pages?page=<?= isset($_GET['page']) && $_GET['page'] >= 1 ? $_GET['page'] - 1 : 1 ?>"
                  aria-controls="example1" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
              <?php for ($i = 0; $i < $data['paginate']; $i++): ?>
                <form action="" method="post">
                  <li class="paginate_button page-item"><a href="<?= base_url; ?>/produk/pages?page=<?= $i + 1 ?>"
              ...
              <li
                ...
                id="example1_next"><a
                  href="<?= base_url; ?>/produk/pages?page=<?= isset($_GET['page']) && $_GET['page'] < $data['paginate'] ? $_GET['page'] + 1 : 1 ?>"
