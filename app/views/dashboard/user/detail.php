              ...
              <div class="col-7">
                ...
                <ul class="ml-4 mb-3  fa-ul text-muted">
                  <li class="small mb-2"><span class="fa-li"><i
                        class="fas fa-lg fa-venus-mars"></i></span><?= $data['user']['jenis_kelamin']; ?></li>
                  <!-- <?php var_dump($data['user']); ?> -->
                  <li class="small mb-2"><span class="fa-li"><i
                        class="fas fa-lg fa-building"></i></span><?= $data['user']['alamat'] ? $data['user']['alamat']['alamat_lengkap'] : '-'; ?>
                  </li>
                  <li class="small mb-2"><span class="fa-li"><i
                        class="fas fa-lg fa-phone"></i></span><?= $data['user']['kontak']; ?></li>
                  <?php if (isset($data['user']['rekening'])): ?>
                    <li class="small mb-2"><span class="fa-li"><i
                          class="fas fa-lg fa-credit-card"></i></span><?= $data['user']['rekening']; ?></li>
                  <?php endif; ?>
                </ul>
              </div>
              <div class="col-5 text-center">
                <img src="<?= base_url . '/assets/img/user/' . $data['user']['photo']; ?>" alt="user-avatar"
