  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <!-- <div class="col-sm-6">
          <a class="btn btn-primary float-right" style="height: ;"
            href="<?= base_url . '/user/alamatLengkap/' . $data['user']['id']; ?>" class="nav-link">
            Ubah Alamat lengkap
          </a>
        </div> -->
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <Select class="form-control" name="jenis_kelamin">
              <Option value="laki-laki" <?php if ($data['user']['jenis_kelamin'] == 'laki-laki')
                echo 'selected'; ?>>
                Laki-laki</Option>
              <Option value="perempuan" <?php if ($data['user']['jenis_kelamin'] == 'perempuan')
                echo 'selected'; ?>>
                Perempuan</Option>
            </Select>
          </div>
