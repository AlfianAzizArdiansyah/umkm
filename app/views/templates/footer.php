        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_nav_container">
                    <div class="cr">©2026 All Rights Reserverd. Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">alfinardiansyah</a> &amp; distributed by <a href="https://themewagon.com">themewagon.com</a></div>
                </div>
            </div>
        </div>
    </div>
