			...
			<div class="breadcrumbs d-flex flex-row align-items-center">
				<ul>
					...
					<li><a href="#"><i class="fa fa-angle-right"
								aria-hidden="true"></i><?= $data['produk']['nama_kategori'] ?></a></li>
					<li class="active"><a href="#"><i class="fa fa-angle-right"
								aria-hidden="true"></i><?= $data['produk']['nama_produk'] ?></a></li>
				</ul>
			</div>
		</div>
	</div>
					...
					<div class="col-lg-12 image_col order-lg-2 order-1">
						<div class="single_product_image">
							<div class="single_product_image_background"
								style="background-image:url(<?= base_url . '/assets/img/produk/' . $data['produk']['gambar'] ?>)">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-lg-5">
			<div class="product_details">
				...
				<div class="pesan">
					...
					<a class="btn btn-order btn-success" href="https://wa.me/+62<?= $data['produk']['kontak']; ?>">Pesan
						via WA</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-between">
				...
				<div>
					<a href="https://wa.me/+62<?= $data['produk']['kontak']; ?>"
						class="btn btn-success float-right ml-2">Kirim Bukti Pembayaran</a>
